...
class CustomFieldViewTest(TestCase):
    ...
    def test_custom_fields_manage_view_get(self):
        """Test GET request to custom fields management view"""
        self.client.login(username='testuser', password='testpass123')
        response = self.client.get(reverse('custom_fields_manage', args=[self.dataset.id]))
    ...
    def test_custom_fields_manage_view_unauthorized_user(self):
    ...
    def test_custom_field_create_view_post_valid(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(response, reverse('custom_fields_manage', args=[self.dataset.id]))
    ...
    def test_custom_field_views_unauthorized_user(self):
        ...
        views_to_test = [
            ('custom_fields_manage', [self.dataset.id]),
