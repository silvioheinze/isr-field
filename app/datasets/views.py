...
def entry_edit_view(request, entry_id):
    ...
    return render(request, 'datasets/entry_edit.html', {'entry': entry})
...
def typology_create_view(request):
            ...
            if key.startswith('entry_code_'):
                ...
                if code and category and name_entry:
                    try:
                        ...
                        typology.delete()
                        return render(request, 'datasets/typology_create.html', {'form': {'name': {'value': name}}})
    ...
    return render(request, 'datasets/typology_create.html', {'dataset_id': request.GET.get('dataset_id')})
...
def typology_select_view(request, dataset_id):
    ...
    return render(request, 'datasets/typology_select.html', {
        'dataset': dataset,
...
def typology_export_view(request, typology_id):
    ...
    return render(request, 'datasets/typology_export.html', {
        'typology': typology,
